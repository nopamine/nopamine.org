...
export const SVGGenerator = ({
  ...
  return (
    <svg
      ...
      height={height}
      viewBox={viewBox}
      style={{ ...style, display: 'block', transform: 'translateZ(0)' }}
    >
      <path
        stroke={borderColor}
      ...
      >
        {
          <animate
            ...
            keyTimes={new Array(path.length + 1)
              .fill(path.length)
...
export const LandingPageBlob1 = (props) => (
  <SVGGenerator
    borderColor={props.borderColor ? props.borderColor : theme.colors.red}
    backgroundColor={props.backgroundColor ? props.backgroundColor : ''}
    borderWidth={45}
    delay={0}
    style={{ position: 'absolute', top: 0, right: 0, zIndex: -1, width: '100vw', height: '100vh' }}
    width="1649px"
    height="748px"
...
export const LandingPageBlob2 = (props) => (
  <SVGGenerator
...
export const LandingPageBlob3 = (props) => (
  <SVGGenerator
...
export const MotivationPageBlobs = () => (
  <React.Fragment>
...
const StaticEye = (props) => (
  <svg width="1649px" height="748px" viewBox="0 0 1649 748" {...props}>
    <path
      d="M453.7432,657.9998 C296.7522,657.9998 296.7522,89.9998 453.7432,89.9998 C610.7342,89.9998 738.0002,217.1508 738.0002,373.9998 C738.0002,530.8488 610.7342,657.9998 453.7432,657.9998"
      id="Shadow"
      fillOpacity="0.3"
      fill="#FFFFFF"
    ></path>
    <path
      d="M475.2568,657.9998 C632.2478,657.9998 632.2478,89.9998 475.2568,89.9998 C318.2658,89.9998 190.9998,217.1508 190.9998,373.9998 C190.9998,530.8488 318.2658,657.9998 475.2568,657.9998"
      id="Globe"
      fill="#FFFFFF"
    ></path>
  </svg>
...
export const Eye = (props) => (
  <figure style={{ position: 'absolute', top: 0, left: 0, ...props.style }}>
    <StaticEye />
    <Iris />
    <Lens />
  </figure>
